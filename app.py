                        ...
                        with col4:
                            if set_num == 0 and actual_sets > 1:
                                if st.button("全適用", key=f"copy_all_{idx}", help="この設定を全セットに適用"):
                                    ...
                                    copy_data = {
                                        'unit': unit,
                                        'unit_index': units_list.index(unit),
                                        'reps': set_rep,
                                    }
                                    if unit == "その他":
                                        copy_data['load_text'] = set_load
                                        ...
                                        copy_data['load_text'] = ""
                                        copy_data['load_value'] = load_value
